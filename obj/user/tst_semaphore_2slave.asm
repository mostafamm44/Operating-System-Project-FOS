...
_main(void)
{
  ...
  80003e:	e8 2a 13 00 00       	call   80136d <sys_getenvindex>
  800043:	89 45 f4             	mov    %eax,-0xc(%ebp)

	int32 parentenvID = sys_getparentenvid();
  800046:	e8 3b 13 00 00       	call   801386 <sys_getparentenvid>
  ...
  80005c:	50                   	push   %eax
  80005d:	e8 6a 16 00 00       	call   8016cc <get_semaphore>
  ...
  800095:	e8 50 02 00 00       	call   8002ea <cprintf>
  80009a:	83 c4 10             	add    $0x10,%esp
		env_sleep(1000) ;
  80009d:	83 ec 0c             	sub    $0xc,%esp
  8000a0:	68 e8 03 00 00       	push   $0x3e8
  8000a5:	e8 7b 16 00 00       	call   801725 <env_sleep>
  8000aa:	83 c4 10             	add    $0x10,%esp
	}
	signal_semaphore(shopCapacitySem);
  8000ad:	83 ec 0c             	sub    $0xc,%esp
  8000b0:	ff 75 ec             	pushl  -0x14(%ebp)
  8000b3:	e8 48 16 00 00       	call   801700 <signal_semaphore>
  ...
  8000c6:	e8 1f 02 00 00       	call   8002ea <cprintf>
  8000cb:	83 c4 10             	add    $0x10,%esp
	signal_semaphore(dependSem);
  8000ce:	83 ec 0c             	sub    $0xc,%esp
  8000d1:	ff 75 e8             	pushl  -0x18(%ebp)
  8000d4:	e8 27 16 00 00       	call   801700 <signal_semaphore>
...
libmain(int argc, char **argv)
{
  ...
  800153:	68 a0 1c 80 00       	push   $0x801ca0
  ...
  800179:	52                   	push   %edx
  80017a:	50                   	push   %eax
  80017b:	68 c8 1c 80 00       	push   $0x801cc8
  ...
  8001aa:	52                   	push   %edx
  8001ab:	50                   	push   %eax
  8001ac:	68 f0 1c 80 00       	push   $0x801cf0
  ...
  8001c7:	50                   	push   %eax
  8001c8:	68 48 1d 80 00       	push   $0x801d48
  8001cd:	e8 18 01 00 00       	call   8002ea <cprintf>
  8001d2:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  8001d5:	83 ec 0c             	sub    $0xc,%esp
  8001d8:	68 a0 1c 80 00       	push   $0x801ca0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800387:	e8 38 16 00 00       	call   8019c4 <__udivdi3>
  ...
  8003d5:	52                   	push   %edx
  8003d6:	50                   	push   %eax
  8003d7:	e8 f8 16 00 00       	call   801ad4 <__umoddi3>
  8003dc:	83 c4 10             	add    $0x10,%esp
  8003df:	05 74 1f 80 00       	add    $0x801f74,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800532:	8b 04 85 98 1f 80 00 	mov    0x801f98(,%eax,4),%eax
  ...
  800613:	8b 34 9d e0 1d 80 00 	mov    0x801de0(,%ebx,4),%esi
  80061a:	85 f6                	test   %esi,%esi
  80061c:	75 19                	jne    800637 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80061e:	53                   	push   %ebx
  80061f:	68 85 1f 80 00       	push   $0x801f85
  ...
  800632:	e9 5b 02 00 00       	jmp    800892 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800637:	56                   	push   %esi
  800638:	68 8e 1f 80 00       	push   $0x801f8e
  ...
  800663:	75 05                	jne    80066a <vprintfmt+0x1a6>
				p = "(null)";
  800665:	be 91 1f 80 00       	mov    $0x801f91,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  801070:	68 08 21 80 00       	push   $0x802108
  801075:	68 3f 01 00 00       	push   $0x13f
  80107a:	68 2a 21 80 00       	push   $0x80212a
  80107f:	e8 55 07 00 00       	call   8017d9 <_panic>
...
struct semaphore create_semaphore(char *semaphoreName, uint32 value)
{
  ...
  8016bb:	68 38 21 80 00       	push   $0x802138
  8016c0:	6a 09                	push   $0x9
  8016c2:	68 60 21 80 00       	push   $0x802160
  8016c7:	e8 0d 01 00 00       	call   8017d9 <_panic>

008016cc <get_semaphore>:
	//Your Code is Here...
}
struct semaphore get_semaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8016d5:	68 70 21 80 00       	push   $0x802170
  8016da:	6a 10                	push   $0x10
  8016dc:	68 60 21 80 00       	push   $0x802160
  8016e1:	e8 f3 00 00 00       	call   8017d9 <_panic>

008016e6 <wait_semaphore>:
	//Your Code is Here...
}
...
void wait_semaphore(struct semaphore sem)
{
  ...
  8016ef:	68 98 21 80 00       	push   $0x802198
  8016f4:	6a 18                	push   $0x18
  8016f6:	68 60 21 80 00       	push   $0x802160
  8016fb:	e8 d9 00 00 00       	call   8017d9 <_panic>

00801700 <signal_semaphore>:
	//Your Code is Here...
}
...
void signal_semaphore(struct semaphore sem)
{
  ...
  801709:	68 c0 21 80 00       	push   $0x8021c0
  80170e:	6a 20                	push   $0x20
  801710:	68 60 21 80 00       	push   $0x802160
  801715:	e8 bf 00 00 00       	call   8017d9 <_panic>

0080171a <semaphore_count>:
	//Your Code is Here...
}
...
int semaphore_count(struct semaphore sem)
{
  ...
  801720:	8b 40 10             	mov    0x10(%eax),%eax
}
  801723:	5d                   	pop    %ebp
  801724:	c3                   	ret    
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801730:	c1 e0 02             	shl    $0x2,%eax
  801733:	01 d0                	add    %edx,%eax
  801735:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  80175d:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801760:	83 ec 0c             	sub    $0xc,%esp
  801763:	50                   	push   %eax
  801764:	e8 50 fc ff ff       	call   8013b9 <sys_get_virtual_time>
  801769:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  80176c:	eb 41                	jmp    8017af <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  80176e:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801771:	83 ec 0c             	sub    $0xc,%esp
  801774:	50                   	push   %eax
  801775:	e8 3f fc ff ff       	call   8013b9 <sys_get_virtual_time>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  8017b2:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  8017b5:	72 b7                	jb     80176e <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  8017bd:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  8017c0:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  8017c7:	eb 03                	jmp    8017cc <busy_wait+0x12>
  8017c9:	ff 45 fc             	incl   -0x4(%ebp)
  8017cc:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8017cf:	3b 45 08             	cmp    0x8(%ebp),%eax
  8017d2:	72 f5                	jb     8017c9 <busy_wait+0xf>
	return i;
  8017d4:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
  8017d7:	c9                   	leave  
  8017d8:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8017e2:	83 c0 04             	add    $0x4,%eax
  8017e5:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8017e8:	a1 24 30 80 00       	mov    0x803024,%eax
  8017ed:	85 c0                	test   %eax,%eax
  8017ef:	74 16                	je     801807 <_panic+0x2e>
		cprintf("%s: ", argv0);
  8017f1:	a1 24 30 80 00       	mov    0x803024,%eax
  8017f6:	83 ec 08             	sub    $0x8,%esp
  8017f9:	50                   	push   %eax
  8017fa:	68 e8 21 80 00       	push   $0x8021e8
  8017ff:	e8 e6 ea ff ff       	call   8002ea <cprintf>
  801804:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  801807:	a1 00 30 80 00       	mov    0x803000,%eax
  80180c:	ff 75 0c             	pushl  0xc(%ebp)
  80180f:	ff 75 08             	pushl  0x8(%ebp)
  801812:	50                   	push   %eax
  801813:	68 ed 21 80 00       	push   $0x8021ed
  801818:	e8 cd ea ff ff       	call   8002ea <cprintf>
  ...
  801829:	50                   	push   %eax
  80182a:	e8 50 ea ff ff       	call   80027f <vcprintf>
  80182f:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801832:	83 ec 08             	sub    $0x8,%esp
  801835:	6a 00                	push   $0x0
  801837:	68 09 22 80 00       	push   $0x802209
  80183c:	e8 3e ea ff ff       	call   80027f <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801844:	e8 bf e9 ff ff       	call   800208 <exit>

	// should not return here
	while (1) ;
  801849:	eb fe                	jmp    801849 <_panic+0x70>

0080184b <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801851:	a1 04 30 80 00       	mov    0x803004,%eax
  801856:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  80185c:	8b 45 0c             	mov    0xc(%ebp),%eax
  80185f:	39 c2                	cmp    %eax,%edx
  801861:	74 14                	je     801877 <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  801863:	83 ec 04             	sub    $0x4,%esp
  801866:	68 0c 22 80 00       	push   $0x80220c
  80186b:	6a 26                	push   $0x26
  80186d:	68 58 22 80 00       	push   $0x802258
  801872:	e8 62 ff ff ff       	call   8017d9 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  801877:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  80187e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801885:	e9 c5 00 00 00       	jmp    80194f <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  80188a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80188d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801894:	8b 45 08             	mov    0x8(%ebp),%eax
  801897:	01 d0                	add    %edx,%eax
  801899:	8b 00                	mov    (%eax),%eax
  80189b:	85 c0                	test   %eax,%eax
  80189d:	75 08                	jne    8018a7 <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  80189f:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  8018a2:	e9 a5 00 00 00       	jmp    80194c <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  8018a7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8018ae:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  8018b5:	eb 69                	jmp    801920 <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  8018b7:	a1 04 30 80 00       	mov    0x803004,%eax
  8018bc:	8b 88 7c 05 00 00    	mov    0x57c(%eax),%ecx
  8018c2:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8018c5:	89 d0                	mov    %edx,%eax
  8018c7:	01 c0                	add    %eax,%eax
  8018c9:	01 d0                	add    %edx,%eax
  8018cb:	c1 e0 03             	shl    $0x3,%eax
  8018ce:	01 c8                	add    %ecx,%eax
  8018d0:	8a 40 04             	mov    0x4(%eax),%al
  8018d3:	84 c0                	test   %al,%al
  8018d5:	75 46                	jne    80191d <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  8018d7:	a1 04 30 80 00       	mov    0x803004,%eax
  8018dc:	8b 88 7c 05 00 00    	mov    0x57c(%eax),%ecx
  ...
  8018f5:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8018f8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  8018fd:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  8018ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801902:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801912:	75 09                	jne    80191d <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  801914:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  80191b:	eb 15                	jmp    801932 <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
  ...
  801920:	a1 04 30 80 00       	mov    0x803004,%eax
  801925:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  80192b:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80192e:	39 c2                	cmp    %eax,%edx
  801930:	77 85                	ja     8018b7 <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  801932:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801936:	75 14                	jne    80194c <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  801938:	83 ec 04             	sub    $0x4,%esp
  80193b:	68 64 22 80 00       	push   $0x802264
  801940:	6a 3a                	push   $0x3a
  801942:	68 58 22 80 00       	push   $0x802258
  801947:	e8 8d fe ff ff       	call   8017d9 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  80194c:	ff 45 f0             	incl   -0x10(%ebp)
  80194f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801952:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801955:	0f 8c 2f ff ff ff    	jl     80188a <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  801969:	eb 26                	jmp    801991 <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  80196b:	a1 04 30 80 00       	mov    0x803004,%eax
  801970:	8b 88 7c 05 00 00    	mov    0x57c(%eax),%ecx
  801976:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801979:	89 d0                	mov    %edx,%eax
  80197b:	01 c0                	add    %eax,%eax
  80197d:	01 d0                	add    %edx,%eax
  80197f:	c1 e0 03             	shl    $0x3,%eax
  801982:	01 c8                	add    %ecx,%eax
  801984:	8a 40 04             	mov    0x4(%eax),%al
  801987:	3c 01                	cmp    $0x1,%al
  801989:	75 03                	jne    80198e <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  80198b:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80198e:	ff 45 e0             	incl   -0x20(%ebp)
  801991:	a1 04 30 80 00       	mov    0x803004,%eax
  801996:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  80199c:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80199f:	39 c2                	cmp    %eax,%edx
  8019a1:	77 c8                	ja     80196b <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  8019a6:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  8019a9:	74 14                	je     8019bf <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  8019ab:	83 ec 04             	sub    $0x4,%esp
  8019ae:	68 b8 22 80 00       	push   $0x8022b8
  8019b3:	6a 44                	push   $0x44
  8019b5:	68 58 22 80 00       	push   $0x802258
  8019ba:	e8 1a fe ff ff       	call   8017d9 <_panic>
...
008019c4 <__udivdi3>:
  ...
  8019cb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  8019cf:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  8019d3:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8019d7:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8019db:	89 ca                	mov    %ecx,%edx
  8019dd:	89 f8                	mov    %edi,%eax
  8019df:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  8019e3:	85 f6                	test   %esi,%esi
  8019e5:	75 2d                	jne    801a14 <__udivdi3+0x50>
  8019e7:	39 cf                	cmp    %ecx,%edi
  8019e9:	77 65                	ja     801a50 <__udivdi3+0x8c>
  8019eb:	89 fd                	mov    %edi,%ebp
  8019ed:	85 ff                	test   %edi,%edi
  8019ef:	75 0b                	jne    8019fc <__udivdi3+0x38>
  8019f1:	b8 01 00 00 00       	mov    $0x1,%eax
  8019f6:	31 d2                	xor    %edx,%edx
  8019f8:	f7 f7                	div    %edi
  8019fa:	89 c5                	mov    %eax,%ebp
  8019fc:	31 d2                	xor    %edx,%edx
  8019fe:	89 c8                	mov    %ecx,%eax
  801a00:	f7 f5                	div    %ebp
  801a02:	89 c1                	mov    %eax,%ecx
  801a04:	89 d8                	mov    %ebx,%eax
  801a06:	f7 f5                	div    %ebp
  801a08:	89 cf                	mov    %ecx,%edi
  ...
  801a16:	77 28                	ja     801a40 <__udivdi3+0x7c>
  801a18:	0f bd fe             	bsr    %esi,%edi
  801a1b:	83 f7 1f             	xor    $0x1f,%edi
  801a1e:	75 40                	jne    801a60 <__udivdi3+0x9c>
  801a20:	39 ce                	cmp    %ecx,%esi
  801a22:	72 0a                	jb     801a2e <__udivdi3+0x6a>
  801a24:	3b 44 24 08          	cmp    0x8(%esp),%eax
  801a28:	0f 87 9e 00 00 00    	ja     801acc <__udivdi3+0x108>
  801a2e:	b8 01 00 00 00       	mov    $0x1,%eax
  801a33:	89 fa                	mov    %edi,%edx
  ...
  801a5e:	5d                   	pop    %ebp
  801a5f:	c3                   	ret    
  801a60:	bd 20 00 00 00       	mov    $0x20,%ebp
  801a65:	89 eb                	mov    %ebp,%ebx
  801a67:	29 fb                	sub    %edi,%ebx
  801a69:	89 f9                	mov    %edi,%ecx
  801a6b:	d3 e6                	shl    %cl,%esi
  801a6d:	89 c5                	mov    %eax,%ebp
  801a6f:	88 d9                	mov    %bl,%cl
  801a71:	d3 ed                	shr    %cl,%ebp
  801a73:	89 e9                	mov    %ebp,%ecx
  801a75:	09 f1                	or     %esi,%ecx
  801a77:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801a7b:	89 f9                	mov    %edi,%ecx
  801a7d:	d3 e0                	shl    %cl,%eax
  801a7f:	89 c5                	mov    %eax,%ebp
  801a81:	89 d6                	mov    %edx,%esi
  801a83:	88 d9                	mov    %bl,%cl
  801a85:	d3 ee                	shr    %cl,%esi
  801a87:	89 f9                	mov    %edi,%ecx
  801a89:	d3 e2                	shl    %cl,%edx
  801a8b:	8b 44 24 08          	mov    0x8(%esp),%eax
  801a8f:	88 d9                	mov    %bl,%cl
  801a91:	d3 e8                	shr    %cl,%eax
  801a93:	09 c2                	or     %eax,%edx
  801a95:	89 d0                	mov    %edx,%eax
  801a97:	89 f2                	mov    %esi,%edx
  801a99:	f7 74 24 0c          	divl   0xc(%esp)
  801a9d:	89 d6                	mov    %edx,%esi
  801a9f:	89 c3                	mov    %eax,%ebx
  801aa1:	f7 e5                	mul    %ebp
  801aa3:	39 d6                	cmp    %edx,%esi
  801aa5:	72 19                	jb     801ac0 <__udivdi3+0xfc>
  801aa7:	74 0b                	je     801ab4 <__udivdi3+0xf0>
  801aa9:	89 d8                	mov    %ebx,%eax
  801aab:	31 ff                	xor    %edi,%edi
  801aad:	e9 58 ff ff ff       	jmp    801a0a <__udivdi3+0x46>
  801ab2:	66 90                	xchg   %ax,%ax
  801ab4:	8b 54 24 08          	mov    0x8(%esp),%edx
  801ab8:	89 f9                	mov    %edi,%ecx
  801aba:	d3 e2                	shl    %cl,%edx
  801abc:	39 c2                	cmp    %eax,%edx
  801abe:	73 e9                	jae    801aa9 <__udivdi3+0xe5>
  801ac0:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801ac3:	31 ff                	xor    %edi,%edi
  801ac5:	e9 40 ff ff ff       	jmp    801a0a <__udivdi3+0x46>
  801aca:	66 90                	xchg   %ax,%ax
  801acc:	31 c0                	xor    %eax,%eax
  801ace:	e9 37 ff ff ff       	jmp    801a0a <__udivdi3+0x46>
  801ad3:	90                   	nop
...
00801ad4 <__umoddi3>:
  ...
  801adb:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  801adf:	8b 74 24 34          	mov    0x34(%esp),%esi
  801ae3:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801ae7:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  801aeb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801aef:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801af3:	89 f3                	mov    %esi,%ebx
  801af5:	89 fa                	mov    %edi,%edx
  801af7:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801afb:	89 34 24             	mov    %esi,(%esp)
  801afe:	85 c0                	test   %eax,%eax
  801b00:	75 1a                	jne    801b1c <__umoddi3+0x48>
  801b02:	39 f7                	cmp    %esi,%edi
  801b04:	0f 86 a2 00 00 00    	jbe    801bac <__umoddi3+0xd8>
  ...
  801b1a:	5d                   	pop    %ebp
  801b1b:	c3                   	ret    
  801b1c:	39 f0                	cmp    %esi,%eax
  801b1e:	0f 87 ac 00 00 00    	ja     801bd0 <__umoddi3+0xfc>
  801b24:	0f bd e8             	bsr    %eax,%ebp
  801b27:	83 f5 1f             	xor    $0x1f,%ebp
  801b2a:	0f 84 ac 00 00 00    	je     801bdc <__umoddi3+0x108>
  801b30:	bf 20 00 00 00       	mov    $0x20,%edi
  801b35:	29 ef                	sub    %ebp,%edi
  801b37:	89 fe                	mov    %edi,%esi
  801b39:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801b3d:	89 e9                	mov    %ebp,%ecx
  801b3f:	d3 e0                	shl    %cl,%eax
  801b41:	89 d7                	mov    %edx,%edi
  801b43:	89 f1                	mov    %esi,%ecx
  801b45:	d3 ef                	shr    %cl,%edi
  801b47:	09 c7                	or     %eax,%edi
  801b49:	89 e9                	mov    %ebp,%ecx
  801b4b:	d3 e2                	shl    %cl,%edx
  801b4d:	89 14 24             	mov    %edx,(%esp)
  801b50:	89 d8                	mov    %ebx,%eax
  801b52:	d3 e0                	shl    %cl,%eax
  801b54:	89 c2                	mov    %eax,%edx
  801b56:	8b 44 24 08          	mov    0x8(%esp),%eax
  801b5a:	d3 e0                	shl    %cl,%eax
  801b5c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b60:	8b 44 24 08          	mov    0x8(%esp),%eax
  801b64:	89 f1                	mov    %esi,%ecx
  801b66:	d3 e8                	shr    %cl,%eax
  801b68:	09 d0                	or     %edx,%eax
  801b6a:	d3 eb                	shr    %cl,%ebx
  801b6c:	89 da                	mov    %ebx,%edx
  801b6e:	f7 f7                	div    %edi
  801b70:	89 d3                	mov    %edx,%ebx
  801b72:	f7 24 24             	mull   (%esp)
  801b75:	89 c6                	mov    %eax,%esi
  801b77:	89 d1                	mov    %edx,%ecx
  801b79:	39 d3                	cmp    %edx,%ebx
  801b7b:	0f 82 87 00 00 00    	jb     801c08 <__umoddi3+0x134>
  801b81:	0f 84 91 00 00 00    	je     801c18 <__umoddi3+0x144>
  801b87:	8b 54 24 04          	mov    0x4(%esp),%edx
  801b8b:	29 f2                	sub    %esi,%edx
  801b8d:	19 cb                	sbb    %ecx,%ebx
  801b8f:	89 d8                	mov    %ebx,%eax
  801b91:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  801b95:	d3 e0                	shl    %cl,%eax
  801b97:	89 e9                	mov    %ebp,%ecx
  801b99:	d3 ea                	shr    %cl,%edx
  801b9b:	09 d0                	or     %edx,%eax
  801b9d:	89 e9                	mov    %ebp,%ecx
  801b9f:	d3 eb                	shr    %cl,%ebx
  801ba1:	89 da                	mov    %ebx,%edx
  801ba3:	83 c4 1c             	add    $0x1c,%esp
  801ba6:	5b                   	pop    %ebx
  801ba7:	5e                   	pop    %esi
  801ba8:	5f                   	pop    %edi
  801ba9:	5d                   	pop    %ebp
  801baa:	c3                   	ret    
  801bab:	90                   	nop
  801bac:	89 fd                	mov    %edi,%ebp
  801bae:	85 ff                	test   %edi,%edi
  801bb0:	75 0b                	jne    801bbd <__umoddi3+0xe9>
  801bb2:	b8 01 00 00 00       	mov    $0x1,%eax
  801bb7:	31 d2                	xor    %edx,%edx
  801bb9:	f7 f7                	div    %edi
  ...
  801bc9:	e9 44 ff ff ff       	jmp    801b12 <__umoddi3+0x3e>
  ...
  801bda:	5d                   	pop    %ebp
  801bdb:	c3                   	ret    
  801bdc:	3b 04 24             	cmp    (%esp),%eax
  801bdf:	72 06                	jb     801be7 <__umoddi3+0x113>
  801be1:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  801be5:	77 0f                	ja     801bf6 <__umoddi3+0x122>
  801be7:	89 f2                	mov    %esi,%edx
  801be9:	29 f9                	sub    %edi,%ecx
  801beb:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  801bef:	89 14 24             	mov    %edx,(%esp)
  801bf2:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801bf6:	8b 44 24 04          	mov    0x4(%esp),%eax
  801bfa:	8b 14 24             	mov    (%esp),%edx
  ...
  801c08:	2b 04 24             	sub    (%esp),%eax
  801c0b:	19 fa                	sbb    %edi,%edx
  801c0d:	89 d1                	mov    %edx,%ecx
  801c0f:	89 c6                	mov    %eax,%esi
  801c11:	e9 71 ff ff ff       	jmp    801b87 <__umoddi3+0xb3>
  801c16:	66 90                	xchg   %ax,%ax
  801c18:	39 44 24 04          	cmp    %eax,0x4(%esp)
  801c1c:	72 ea                	jb     801c08 <__umoddi3+0x134>
  801c1e:	89 d9                	mov    %ebx,%ecx
  801c20:	e9 62 ff ff ff       	jmp    801b87 <__umoddi3+0xb3>
